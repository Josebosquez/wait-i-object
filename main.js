...
myCodeImmersivesObj.exAnExcellentObject = true;
...
empty.address.city = "Somewhere",
empty.address.state = "Over the rainbow",
empty.address.zip = "way up high"
